  ...
  void render(Canvas c) {
    if (game.activeMode == Mode.twoPlayer || game.activeMode == Mode.threePlayer || game.activeMode == Mode.fourPlayer) {
      ...
      if (color == 'green' && game.dice_green.choosePlayer &&
          ...
          game.player_green_2.total_moved + game.dice_green.rolled <= 57 && ((game.blocked.contains(game.player_green_2.location + game.dice_green.rolled) == false && game.player_green_2.location + game.dice_green.rolled <= 52) || ((game.blocked.contains(game.player_green_2.location + game.dice_green.rolled - 52) == false && game.player_green_2.location + game.dice_green.rolled >= 53))) && (game.player_green_2.position != 0 || game.blocked.contains(1) == false) && (game.blocked_logic(game.barrier, game.dice_green.rolled, game.player_green_2.location) == false)) {
        c.drawCircle(Offset(
      ...
      if (color == 'green' && game.dice_green.choosePlayer &&
          ...
          game.player_green_3.total_moved + game.dice_green.rolled <= 57 && ((game.blocked.contains(game.player_green_3.location + game.dice_green.rolled) == false && game.player_green_3.location + game.dice_green.rolled <= 52) || ((game.blocked.contains(game.player_green_3.location + game.dice_green.rolled - 52) == false && game.player_green_3.location + game.dice_green.rolled >= 53))) && (game.player_green_3.position != 0 || game.blocked.contains(1) == false) && (game.blocked_logic(game.barrier, game.dice_green.rolled, game.player_green_3.location) == false)) {
        c.drawCircle(Offset(
      ...
      if (color == 'green' && game.dice_green.choosePlayer &&
          ...
          game.player_green_4.total_moved + game.dice_green.rolled <= 57 && ((game.blocked.contains(game.player_green_4.location + game.dice_green.rolled) == false && game.player_green_4.location + game.dice_green.rolled <= 52) || ((game.blocked.contains(game.player_green_4.location + game.dice_green.rolled - 52) == false && game.player_green_4.location + game.dice_green.rolled >= 53))) && (game.player_green_4.position != 0 || game.blocked.contains(1) == false) && (game.blocked_logic(game.barrier, game.dice_green.rolled, game.player_green_4.location) == false)) {
        c.drawCircle(Offset(
    ...
    if (game.activeMode == Mode.fourPlayer) {
      ...
      if (color == 'yellow' && game.dice_yellow.choosePlayer &&
          ...
          game.dice_yellow.rolled == 6) &&
          game.player_yellow_2.total_moved + game.dice_yellow.rolled <= 57 && ((game.blocked.contains(game.player_yellow_2.location + game.dice_yellow.rolled) == false && game.player_yellow_2.location + game.dice_yellow.rolled <= 52) || ((game.blocked.contains(game.player_yellow_2.location + game.dice_yellow.rolled - 52) == false && game.player_yellow_2.location + game.dice_yellow.rolled >= 53))) && (game.player_yellow_2.position != 0 || game.blocked.contains(14) == false) && (game.blocked_logic(game.barrier, game.dice_yellow.rolled, game.player_yellow_2.location) == false)) {
        c.drawCircle(Offset(
      ...
      if (color == 'yellow' && game.dice_yellow.choosePlayer &&
          ...
          game.dice_yellow.rolled == 6) &&
          game.player_yellow_3.total_moved + game.dice_yellow.rolled <= 57 && ((game.blocked.contains(game.player_yellow_3.location + game.dice_yellow.rolled) == false && game.player_yellow_3.location + game.dice_yellow.rolled <= 52) || ((game.blocked.contains(game.player_yellow_3.location + game.dice_yellow.rolled - 52) == false && game.player_yellow_3.location + game.dice_yellow.rolled >= 53))) && (game.player_yellow_3.position != 0 || game.blocked.contains(14) == false) && (game.blocked_logic(game.barrier, game.dice_yellow.rolled, game.player_yellow_3.location) == false)) {
        c.drawCircle(Offset(
    ...
    if (game.activeMode == Mode.threePlayer || game.activeMode == Mode.fourPlayer) {
      if (color == 'red' && game.dice_red.choosePlayer && player_number == 1 &&
          ...
          game.player_red_1.total_moved + game.dice_red.rolled <= 57 && ((game.blocked.contains(game.player_red_1.location + game.dice_red.rolled) == false && game.player_red_1.location + game.dice_red.rolled <= 52) || ((game.blocked.contains(game.player_red_1.location + game.dice_red.rolled - 52) == false && game.player_red_1.location + game.dice_red.rolled >= 53))) && (game.player_red_1.position != 0 || game.blocked.contains(40) == false) && (game.blocked_logic(game.barrier, game.dice_red.rolled, game.player_red_1.location) == false)) {
      ...
      if (color == 'red' && game.dice_red.choosePlayer && player_number == 2 &&
          ...
          game.player_red_2.total_moved + game.dice_red.rolled <= 57 && ((game.blocked.contains(game.player_red_2.location + game.dice_red.rolled) == false && game.player_red_2.location + game.dice_red.rolled <= 52) || ((game.blocked.contains(game.player_red_2.location + game.dice_red.rolled - 52) == false && game.player_red_2.location + game.dice_red.rolled >= 53))) && (game.player_red_2.position != 0 || game.blocked.contains(40) == false) && (game.blocked_logic(game.barrier, game.dice_red.rolled, game.player_red_2.location) == false)) {
      ...
      if (color == 'red' && game.dice_red.choosePlayer && player_number == 3 &&
          ...
          game.player_red_3.total_moved + game.dice_red.rolled <= 57 && ((game.blocked.contains(game.player_red_3.location + game.dice_red.rolled) == false && game.player_red_3.location + game.dice_red.rolled <= 52) || ((game.blocked.contains(game.player_red_3.location + game.dice_red.rolled - 52) == false && game.player_red_3.location + game.dice_red.rolled >= 53))) && (game.player_red_3.position != 0 || game.blocked.contains(40) == false) && (game.blocked_logic(game.barrier, game.dice_red.rolled, game.player_red_3.location) == false)) {
      ...
      if (color == 'red' && game.dice_red.choosePlayer && player_number == 4 &&
          ...
          game.player_red_4.total_moved + game.dice_red.rolled <= 57 && ((game.blocked.contains(game.player_red_4.location + game.dice_red.rolled) == false && game.player_red_4.location + game.dice_red.rolled <= 52) || ((game.blocked.contains(game.player_red_4.location + game.dice_red.rolled - 52) == false && game.player_red_4.location + game.dice_red.rolled >= 53))) && (game.player_red_4.position != 0 || game.blocked.contains(40) == false) && (game.blocked_logic(game.barrier, game.dice_red.rolled, game.player_red_4.location) == false)) {
